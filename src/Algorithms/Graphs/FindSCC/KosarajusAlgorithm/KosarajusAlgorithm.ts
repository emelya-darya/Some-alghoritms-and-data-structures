...
import { getTopologicalSort } from '../../TopologicalSort/TopologicalSort'

export const kosarajusAlg = function (graph: UnweightedGraphType) {
   ...
   const graphColoring: Record<string, number> = {}
   let color = 1
