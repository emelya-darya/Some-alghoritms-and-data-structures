...
Кружками обозначены вершины, линиями – пути между ними (ребра графа). Посещенные вершины помечены красным, рассматриваемая в данный момент вершина помечается ***ТВ***, соседи ***ТВ*** помечаются синим.
...
- В списке вершин, которые нужно посетить ***vrtxsStack*** [ D, E ].
...
- В списке вершин, которые нужно посетить ***vrtxsStack*** [ D, F ].
...
- В списке вершин, которые нужно посетить ***vrtxsStack*** [ D, G ].
...
К концу шага:
- в списке посещенных ***reachableVrtxs*** есть [ C, D, E, F, G ];
- В списке вершин, которые нужно посетить ***vrtxsStack*** [ D ].
